...
wertyyu=wertyyu.fillna(0)
wertyyu=wertyyu[~wertyyu.iloc[:,0].isin(["日期"])]
wertyyu=wertyyu[~wertyyu.iloc[:,0].isin(["Date"])]  
...
#3、读取待粘贴的表格
xlpath2 = r'D:\运营\Sponsored Products Search term report填充数字版.xlsx'
...
#shanchuduoyuhang.to_excel(r'D:\运营\Sponsored Products Search term report.xlsx',Sheet_name ="Sheet1", index=False)
