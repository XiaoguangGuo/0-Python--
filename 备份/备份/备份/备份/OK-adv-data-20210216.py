...
target_xls = r"D:\PythonDocs\AmazonPlan\adv.xlsx"
#合并后文件的路径
...
#分列
wertyyu = pd.read_excel(r'D:\PythonDocs\AmazonPlan\adv.xlsx')
...
wertyyu100.to_excel(r'D:\PythonDocs\AmazonPlan\adv.xlsx',index=False)
...
#2、读取待复制的表格
xlpath = r'D:\PythonDocs\AmazonPlan\adv.xlsx'

xlworkbook = xlwings.Book(xlpath)
print(xlworkbook)

#3、读取待粘贴的表格
xlpath2 = r'D:\运营\广告\广告周数据\advweekdata.xlsx'
