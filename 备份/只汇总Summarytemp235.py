...
for AllbulkCampaign_Country_oi in AllbulkCampaign_Country_List:
    AllbulkCampaign_Country=AllbulkCampaign.loc[AllbulkCampaign["Country"]==AllbulkCampaign_Country_oi]
    AllbulkCampaign_Country_CampaignList= AllbulkCampaign_Country.loc[AllbulkCampaign_Country["Country"]==AllbulkCampaign_Country_oi99,"Campaign"].drop_duplicates().to_list()

    
    for campaign_oi in AllbulkCampaign_Country_CampaignList:
        campaigntype=AllbulkCampaign_Country.loc[(AllbulkCampaign_Country["Country"]==AllbulkCampaign_Country_oi)&(AllbulkCampaign_Country["Campaign"]==campaign_oi),"Campaign Targeting Type"].values[0][0]
        AllbulkCampaignSKUWEEK[(AllbulkCampaignSKUWEEK["Campaign"]==campaign_oi)&(AllbulkCampaignSKUWEEK["Country"]==AllbulkCampaign_Country_oi),"Campaign Targeting Type"]=campaigntype
