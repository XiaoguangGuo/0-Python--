...
#对于campaign和adgroup有一个是pause的，原来其他的词status为Pause
        dfbulkfile.loc[(dfbulkfile["更新内容"]=="")&(dfbulkfile["Campaign"]==boi_campaign) & (dfbulkfile["Ad Group"]==boi_ADgroup)&(dfbulkfile['Keyword or Product Targeting']!=boi_keyword)&(dfbulkfile["Status"]=="enabled")&((dfbulkfile["Campaign Status"]=="paused")|(dfbulkfile["Ad Group Status"]=="paused")),"更新内容"]="转化率>0.2，开启：无关词关闭 "
        dfbulkfile.loc[(dfbulkfile["更新内容"]=="")&(dfbulkfile["Campaign"]==boi_campaign) & (dfbulkfile["Ad Group"]==boi_ADgroup)&(dfbulkfile['Keyword or Product Targeting']!=boi_keyword)&(dfbulkfile["Status"]=="enabled")&((dfbulkfile["Campaign Status"]=="paused")|(dfbulkfile["Ad Group Status"]=="paused")),"Status"]="paused"
                                                                                                                                                                                                                                   

#对于只要WORD是ause的，打开word status
        dfbulkfile.loc[(dfbulkfile["更新内容"]=="")&(dfbulkfile["Campaign"]==boi_campaign) & (dfbulkfile["Ad Group"]==boi_ADgroup)&(dfbulkfile['Keyword or Product Targeting']==boi_keyword)&(dfbulkfile['Match Type']==boi_Matchtype)&(dfbulkfile["Status"]=="paused"),"更新内容"]="转化率>0.2，开启"
        dfbulkfile.loc[(dfbulkfile["更新内容"]=="")&(dfbulkfile["Campaign"]==boi_campaign) & (dfbulkfile["Ad Group"]==boi_ADgroup)&(dfbulkfile['Keyword or Product Targeting']==boi_keyword)&(dfbulkfile['Match Type']==boi_Matchtype)&(dfbulkfile["Status"]=="paused"),"Status"]="enabled"

####记录
        dfbulkmodifyrecord.loc[(dfbulkfile["Campaign"]==boi_campaign) & (dfbulkmodifyrecord["Ad Group"]==boi_ADgroup)&(dfbulkmodifyrecord['Keyword or Product Targeting']!=boi_keyword)&(dfbulkmodifyrecord['Match Type']==boi_Matchtype),Columnnew1]="bocondition05df"
        dfbulkmodifyrecord.loc[(dfbulkfile["Campaign"]==boi_campaign) & (dfbulkmodifyrecord["Ad Group"]==boi_ADgroup)&(dfbulkmodifyrecord['Keyword or Product Targeting']!=boi_keyword)&(dfbulkmodifyrecord['Match Type']==boi_Matchtype),Columnnew2]="转化率>0.2，开启：无关词关闭 "
        
        
        #dfbulkfile.loc[(dfbulkfile["Campaign"]==boi_campaign) & (dfbulkfile["Ad Group"]==boi_ADgroup)&(dfbulkfile['Keyword or Product Targeting']==boi_keyword)&(dfbulkfile['Match Type']==boi_Matchtype),Columnnew1]="bocondition05df"
        #dfbulkfile.loc[(dfbulkfile["Campaign"]==boi_campaign) & (dfbulkfile["Ad Group"]==boi_ADgroup)&(dfbulkfile['Keyword or Product Targeting']==boi_keyword)&(dfbulkfile['Match Type']==boi_Matchtype),Columnnew2]="转化率>0.2，开启"
##############################################################################################################3
