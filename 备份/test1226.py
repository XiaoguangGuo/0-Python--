...
for countryname in SearchTermAll_Good_Country_list:   #遍历searchTemgood里的国家
    ...
    if n==1:
        ...
        for Stoi in range(0,len(SearchTermAll_Good_Country)):#遍历好词 的行#for A0
            ...
            length_type=len(bulkfile.loc[(bulkfile['Record Type']=="Campaign")&(bulkfile['Campaign']==Stoi_Campaign),"Campaign Targeting Type"]) #Campaignd对应的类型
            ...
            if length_type==0:
               ...
               #生成一个新的campaign
               Allbulk89=Allbulk_Campaign_SKUMax.loc[(Allbulk_Campaign_SKUMax["Campaign"]==Stoi_Campaign)&(Allbulk_Campaign_SKUMax["Country"]==countryname)]
               
                bulkfile_Campaign_SKUMax66=Allbulk89.iloc[[Allbulk89["Spend"].idmax()],[3]].values[0][0]
