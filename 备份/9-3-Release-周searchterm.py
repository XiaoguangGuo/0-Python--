...
#3、读取待粘贴的表格
xlpath2 = r'D:\运营\运行结果数据\Sponsored Products Search term report.xlsx'
...
shanchuduoyuhang=pd.read_excel(r'D:\\运营\\运行结果数据\\Sponsored Products Search term report.xlsx')
...
shanchuduoyuhang.to_excel(r'D:\运营\运行结果数据\Sponsored Products Search term report.xlsx',sheet_name ="Sponsored Product Search Term R", index=False)
