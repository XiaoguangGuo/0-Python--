...
SearchTermAll_Bad=SearchTermAll_Sum[(SearchTermAll_Sum["转化率"]<0.07)&(SearchTermAll_Sum["Clicks"]>=16)]
...
for countryname22 in SearchTermAll_Bad_Country_list:
    ...
    SearchBadwithCountry.to_excel(r'D:\\运营\\2生成过程表\\'+str(countryname22)+"Bad.xlsx")
     
    Bulkfile_SearchTerm_Add78=pd.DataFrame(columns=["Record ID","Record Type","Campaign ID","Campaign","Campaign Daily Budget","Portfolio ID","Campaign Start Date","Campaign End Date","Campaign Targeting Type","Ad Group","Max Bid","Keyword or Product Targeting","Product Targeting ID","Match Type","SKU","Campaign Status","Ad Group Status","Status","Bidding strategy","Placement Type","Increase bids by placement","更改记录"])
    Bulkfile_SearchTerm_Add_auto=pd.DataFrame(columns=["Record ID","Record Type","Campaign ID","Campaign","Campaign Daily Budget","Portfolio ID","Campaign Start Date","Campaign End Date","Campaign Targeting Type","Ad Group","Max Bid","Keyword or Product Targeting","Product Targeting ID","Match Type","SKU","Campaign Status","Ad Group Status","Status","Bidding strategy","Placement Type","Increase bids by placement","更改记录"])
    ...
    if len(SearchBadwithCountry)>0:    
        ...
        if n==1:#F01
            ...
            for oi78 in range(0,len(SearchBadwithCountry)):
