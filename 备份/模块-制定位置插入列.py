...
test=pd.read_csv(salesfilepath+ "\BusinessReport-3-10-20-2-22.csv").assign(Country=os.path.basename("BusinessReport-3-10-20-2-22.csv").split('_')[0])
...
USMXColumnlist=["(Parent) ASIN","(Child) ASIN",	"Title","SKU","Sessions","Session Percentage","Page Views","Page Views Percentage","Buy Box Percentage",
              "Units Ordered","Unit Session Percentage","Ordered Product Sales","Total Order Items","Country"]
