...
#计算相关系数
correlations_SKU_Campaign=correlations_SKU_Campaign(Bulkfiles_DF)
#将Correlations_DF输出至excel
correlations_SKU_Campaign.to_excel(r'D:\运营\2生成过程表\correlations_SKU_Campaign.xlsx',index=False)
