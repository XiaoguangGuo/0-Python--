...
plan=plan["Country","SKU","Asin","Title","皮质层标签","行动方案","日销售目标","周销售目标","大类","小类","手动标签","目标差","广告开启数量",
          "SELLING10","STOCKALL","Fufillable","Zhouzhuan10","GGZZ1","BILI1","ZZ1","ZZ2",
          ...
          "广告金额占比","库存占比","Exchangerate","广告1in美元"]
